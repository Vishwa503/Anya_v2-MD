...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "Vishwa",
    ownernumber: process.env.Owner_Number || "94763214593",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://vishwa:SznFRoj3x5OvRZNT@vishwa.bzc42.mongodb.net/?retryWrites=true&w=majority&appName=vishwa",
    sessionId: process.env.SESSION_ID || "a2p3b2U_Queen-Anya_xOW8=",
